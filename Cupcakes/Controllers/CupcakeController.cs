...
namespace Cupcakes.Controllers
{
    public class CupcakeController : Controller
    {
        ...
        public CupcakeController(ICupcakeRepository repository, HostingEnvironment environment)
        {
        ...
        {
            var repo = _repository.GetCupcakes();
            return View(repo);
        }
        ...
        public void PopulateBakeriesDropDownList(int? selectedBakery = null)
        {
